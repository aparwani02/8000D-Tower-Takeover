...
void fiveCubes(void) {
  ...
  //chassis_move(5,40);
  chassisPIDMoveMax(41, 140);
  //vex::task::sleep(150);
  l1PressedAuton(); //was regular l1pressed
  //chassis_move(-18, 40);
  //vex:task::sleep(2000);
  turn(158, 65); //was -135 //was 155 //elaine changed from 150
  //vex::task::sleep(5000);
  chassisPIDMove(40); //was 37 //was regular move 40 //NOTICE MEEEEEEE elaine wants you to make this smaller (maybe 37?)
  upPressed();
  if(stackInUnload) {
...
void fiveCubesEXPERIMENTAL(void) {
  ...
  chassisPIDMoveMax(48, 140); //was 120, was 40 //elaine changed from 43
  l1PressedAuton();
  //vex::task::sleep(500);
  chassisPIDMoveMax(-31, 140); //was -23, was 125 //elaine changed from 31
  
  vex::task::sleep(75);
  turn(138, 50); //was 40; was -130, was -125, was -120 //elaine changed from 122
...
void upPressedFast() { //make stack vertical
  autonRecord.push_back( "upPressed();");
  stackCurrentPos = StackMotor.rotation(rotationUnits::deg);
  if(stackInStart == true) {
    StackMotor.setVelocity(80, velocityUnits::pct); //was 60 pct
    LeftGrabber.spin(directionType::fwd, 10, velocityUnits::pct); //was 3 pct
    RightGrabber.spin(directionType::fwd, 10, velocityUnits::pct); //was 3 pct
    StackMotor.rotateTo(firstStop, rotationUnits::deg);
    //StackMotor.setVelocity(20, velocityUnits::pct);
//StackMotor.rotateTo(secondStop, rotationUnits::deg);
    StackMotor.setVelocity(20, velocityUnits::pct);
    StackMotor.rotateTo(stackUnloadPos, rotationUnits::deg);
    StackMotor.stop(hold);
    LeftGrabber.stop(hold);
